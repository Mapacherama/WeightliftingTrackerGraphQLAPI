namespace WeightliftingTrackerGraphQLAPI.Data
{
    public static class Queries
    {
        ...
        public const string QuerySelectNutritionByDetails = "SELECT * FROM Workout WHERE Calories = @Calories, Protein = @Protein, Carbohydrates = @Carbohydrates, Fats = @Fats";
        ...
        public const string MutationInsertNewNutrition = "INSERT INTO Workout (FoodName, Calories, Protein, Carbohydrates, Fats) VALUES (@FoodName, @Calories, @Protein, @Carbohydrates, @Fats);";
